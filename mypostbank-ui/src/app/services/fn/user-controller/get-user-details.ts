...
export function getUserDetails(http: HttpClient, rootUrl: string, params?: GetUserDetails$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDetailsDto>> {
...
getUserDetails.PATH = '/user/details';
